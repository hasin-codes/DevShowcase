...
export default function Home() {
  ...
  return (
    <main className="h-[100vh] flex flex-col items-center justify-between" style={{ background: 'linear-gradient(to top, #D4145A , ##E10C22)' }}>

<header className="mt-6 flex gap-6 w-[940px] p-5 fixed top-0 left-1/2 translate-x-[-50%]
         z-10 rounded border border-[#212B50] shadow-md"
         style={{ 
           backgroundColor: 'rgba(3, 8, 27, 0.8)', 
